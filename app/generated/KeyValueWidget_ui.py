...
class Ui_KeyValueWidget(object):
    def setupUi(self, KeyValueWidget):
        ...
        self.chk_item_enabled = QtWidgets.QCheckBox(parent=KeyValueWidget)
        ...
        self.txt_item_name = QtWidgets.QLineEdit(parent=KeyValueWidget)
        ...
        self.txt_item_value = QtWidgets.QLineEdit(parent=KeyValueWidget)
        self.txt_item_value.setObjectName("txt_item_value")
        self.horizontalLayout.addWidget(self.txt_item_value)
        self.btn_remove_item = QtWidgets.QToolButton(parent=KeyValueWidget)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/images/delete-48.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
