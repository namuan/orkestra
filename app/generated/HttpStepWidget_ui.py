...
class Ui_HttpStepWidget(object):
    def setupUi(self, HttpStepWidget):
        ...
        self.http_path = QtWidgets.QFrame(parent=HttpStepWidget)
        self.http_path.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.http_path.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.http_path.setObjectName("http_path")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.http_path)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.cmb_http_method = QtWidgets.QComboBox(parent=self.http_path)
        ...
        self.txt_http_url = QtWidgets.QLineEdit(parent=self.http_path)
        self.txt_http_url.setObjectName("txt_http_url")
        self.horizontalLayout.addWidget(self.txt_http_url)
        self.btn_send_request = QtWidgets.QPushButton(parent=self.http_path)
        ...
        self.splitter = QtWidgets.QSplitter(parent=HttpStepWidget)
        self.splitter.setOrientation(QtCore.Qt.Orientation.Vertical)
        self.splitter.setObjectName("splitter")
        self.http_request = QtWidgets.QFrame(parent=self.splitter)
        self.http_request.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.http_request.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.http_request.setObjectName("http_request")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.http_request)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.tab_request_elements = QtWidgets.QTabWidget(parent=self.http_request)
        ...
        self.txt_http_step_title = QtWidgets.QLineEdit(parent=self.description)
        self.txt_http_step_title.setObjectName("txt_http_step_title")
        self.verticalLayout_2.addWidget(self.txt_http_step_title)
        self.txt_http_step_description = QtWidgets.QPlainTextEdit(parent=self.description)
        ...
        self.lst_http_headers = KeyValueListWidget(parent=self.header_params)
        ...
        self.lst_http_query_params = KeyValueListWidget(parent=self.query_params)
        ...
        self.lst_http_form_params = KeyValueListWidget(parent=self.form_params)
        ...
        self.txt_http_request_body = QtWidgets.QPlainTextEdit(parent=self.request_body)
        ...
        self.http_response = QtWidgets.QFrame(parent=self.splitter)
        self.http_response.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.http_response.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        ...
        self.tab_response_elements = QtWidgets.QTabWidget(parent=self.http_response)
        ...
        self.txt_http_raw_request = QtWidgets.QPlainTextEdit(parent=self.raw_request)
        ...
        self.txt_http_raw_response = QtWidgets.QPlainTextEdit(parent=self.raw_response)
        ...
        self.txt_http_formatted_response = QtWidgets.QPlainTextEdit(parent=self.formatted_response)
