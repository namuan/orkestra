...
class Ui_SqlStepWidget(object):
    def setupUi(self, SqlStepWidget):
        ...
        self.db_connection = QtWidgets.QFrame(parent=SqlStepWidget)
        self.db_connection.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.db_connection.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.db_connection.setObjectName("db_connection")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.db_connection)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.cmb_connections = QtWidgets.QComboBox(parent=self.db_connection)
        self.cmb_connections.setObjectName("cmb_connections")
        self.horizontalLayout.addWidget(self.cmb_connections)
        self.txt_connection_string = QtWidgets.QLineEdit(parent=self.db_connection)
        self.txt_connection_string.setObjectName("txt_connection_string")
        self.horizontalLayout.addWidget(self.txt_connection_string)
        self.btn_db_connect = QtWidgets.QPushButton(parent=self.db_connection)
        ...
        self.splitter = QtWidgets.QSplitter(parent=SqlStepWidget)
        self.splitter.setOrientation(QtCore.Qt.Orientation.Vertical)
        self.splitter.setObjectName("splitter")
        self.sql_request = QtWidgets.QFrame(parent=self.splitter)
        self.sql_request.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.sql_request.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.sql_request.setObjectName("sql_request")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.sql_request)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.tab_request_elements = QtWidgets.QTabWidget(parent=self.sql_request)
        ...
        self.txt_sql_step_description = QtWidgets.QPlainTextEdit(parent=self.description)
        ...
        self.txt_sql_query = QtWidgets.QPlainTextEdit(parent=self.sql_query)
        ...
        self.sql_response = QtWidgets.QFrame(parent=self.splitter)
        self.sql_response.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.sql_response.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.sql_response.setObjectName("sql_response")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout(self.sql_response)
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.tab_response_elements = QtWidgets.QTabWidget(parent=self.sql_response)
        ...
        self.tbl_results = QtWidgets.QTableWidget(parent=self.raw_request)
        ...
        self.frame = QtWidgets.QFrame(parent=self.raw_request)
        ...
        self.num_page = QtWidgets.QSpinBox(parent=self.frame)
        self.num_page.setObjectName("num_page")
        self.horizontalLayout_5.addWidget(self.num_page)
        self.lbl_total_pages = QtWidgets.QLabel(parent=self.frame)
